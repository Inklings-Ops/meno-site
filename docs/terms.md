...
These Terms & Conditions are a contract between you and Menō (referred to in these Terms & Conditions as "Menō", "us" "we" or "our"), the provider of the Menō website and the services accessible from the Menō website (which are collectively referred to in these Terms & Conditions as the "Menō Service").
...
Menō is at the service of providing a streaming bible and broadcasting software. Listen to the broadcast, transmit, share the link, use the bible, and take notes. 
...
EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Menō's INTELLECTUAL PROPERTY RIGHTS. The term "dispute" means any dispute, action, or other controversy between you and us concerning the Services or this agreement, whether in contract, warranty, tort, statute, regulation, ordinance, or any other legal or equitable basis. "Dispute" will be given the broadest possible meaning allowable under law.
